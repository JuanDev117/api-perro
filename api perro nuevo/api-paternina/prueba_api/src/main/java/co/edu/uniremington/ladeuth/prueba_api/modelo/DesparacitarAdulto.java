...
public class DesparacitarAdulto {
    ...
    @Column(nullable = true)
    private String desparacitarInterno;

    @Column(nullable = true)
    private String desparacitarExterno;
    ...
    public DesparacitarAdulto() {}

    /*public DesparacitarAdulto(LocalDateTime fechaCreacion, String idVeterinario, String nombreVeterinario, String apellidoVeterinario,
                              String raza, String nombre, String sexo, Integer edad, String desparacitarInterno,
                              String desparacitarExterno, String observación, Boolean activo) {
        ...
        this.sexo = sexo;
        this.edad = edad;
        this.desparacitarInterno = desparacitarInterno;
        this.desparacitarExterno = desparacitarExterno;
