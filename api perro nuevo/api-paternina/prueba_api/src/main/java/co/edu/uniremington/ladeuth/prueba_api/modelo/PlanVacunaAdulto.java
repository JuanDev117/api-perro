...
public class PlanVacunaAdulto {
    ...
    public PlanVacunaAdulto() {}

    /*public PlanVacunaAdulto(LocalDateTime fechaCreacion, String idVeterinario, String nombreVeterinario, String apellidoVeterinario,
                           String raza, String nombre, String sexo, Integer edad, String polivalente,
                            String leptospirosis, String rabia, String observación, Boolean activo) {
